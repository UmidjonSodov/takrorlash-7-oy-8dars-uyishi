...
function WeatherCart({weather, unit}) {
     ...
     shadow-2xl hover:bg-white/15 transition-all duration-500"
      >
          ...
          <div className="flex items-center justify-between mb-8">
              <div className="flex items-center space-x-3">
                  <div className="p-2 bg-white/10 rounded-full">
                      <MapPin className="w5 h-5 text-white/80" />
                  </div>
                  <div>
          ...
          <div className="flex items-center justify-between mb-10">
              <div className="flex-1">
                  <div className="text-7xl font-bold text-white mb-3 tracking-tight">
                      ...
                      <span className="text-white/70 text-4xl font-normal">
                          {" "}
                          {unit}{" "}
                      </span>
                  </div>
          ...
          <div className="grid grid-cols-2 gap-4">
              <div
                  className="bg-linear-to-r from-orange-500/20 to-yellow-500/20 
              ...
              <div
                  className="bg-linear-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm
